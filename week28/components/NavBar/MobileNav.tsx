...
const MobileNav = ({showNav, closeNav} : NavProps) => {
  ...
  return (
    <div>
        ...
        { /* navlinks */}
        <div className= {`text-white ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-orange-400 space-y-6 z-100050 right-0`}>
            {NavLinks.map((link) => {
